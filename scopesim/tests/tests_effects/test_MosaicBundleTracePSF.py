# -*- coding: utf-8 -*-
"""From psfs/analytical."""

from matplotlib import pyplot as plt

from scopesim.effects.psfs.analytical import MosaicBundleTracePSF, AnalyticalPSF
...
class TestGetKernel:
    def test_returned_kernel_is_zipped_version_of_single_kernel(self):
        ...
        assert kernel.sum() == sum(ws) * mbt_psf.single_kernel.sum()
        # TODO: Not sure what this is supposed to test, but it fails
        #       Perhaps the second one should be the single_kernel??
